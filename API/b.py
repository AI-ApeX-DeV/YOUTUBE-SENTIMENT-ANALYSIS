...
# Initialize a dictionary to store video scores
video_scores = {}
...
# Fetch video statistics to calculate scores
...
# Print the top 30 videos and their scores
print("Top 30 Videos:")
for i, (video_id, score) in enumerate(sorted_videos[:30], start=1):
