...
for video_id in video_ids:
    ...
    # Merge comments into a single variable
    merged_comments = '\n'.join(comments)
...
# Print the top 30 videos and their scores along with the merged comments
print("Top 30 Videos:")
for i, (video_id, data) in enumerate(sorted_videos[:30], start=1):
    ...
    # Print the merged comments for this video
    print("Merged Comments:")
    print(data['comments'])
    print("\n")
